<div class="container col-xs-12" style="margin-top:40px;">
  ...
  <div style="list-style:none; width:100%" class="col-md-12">
    {{ form("valoracion/save", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
    <br>
    {{ hidden_field("idValoracion") }}
    {{ hidden_field("dispositivomedico") }}
    <div id="imprimir">
      ...
      <div class="seccion">
        <div class='fila col2'>
          ...
          <div>{{ text_field("fecha", "type" : "text", "class" : "form-control calendario") }}</div>
        </div>
        <div class='fila col2'>
          <div style='width:15%;'>Diagnostico</div>
          <div style='width:75%;'>
            {{text_area("diagnostico", "class" : "form-control", "style" : "width:100%;")}}
          </div>
        </div>
        ...
        <div class='fila col2'>
          ...
          <div style='width:75%;'>
            {{text_area("antpersonales", "class" : "form-control", "style" : "width:100%;")}}
          </div>
        </div>
        <div class='fila col2'>
          <div style='width:15%;'>Familiares</div>
          <div style='width:75%;'>
            {{text_area("antfamiliares", "class" : "form-control", "style" : "width:100%;")}}
          </div>
        </div>
        ...
        <div class='fila col3e'>
          ...
          <div class='col2da' style="width:25%;">
            {{ text_field("fechaamputacion", "type" : "text", "class" : "form-control calendario") }}
          </div>
        ...
        <div class='fila col2'>
          ...
          <div style='width:75%;'>
            {{text_area("causaamputacion", "class" : "form-control", "style" : "width:100%;")}}
          </div>
        </div>
        ...
        <div class='fila col3e'>
          ...
          <div class='col2da' style="width:15%;">
            {{ select("fuerza1[0]", datosFuerza, "value" : listafuerza1[0], "class" : "form-control") }}
          </div>
          <div class='col2da' style="width:35%;">FLEXORES</div>
          <div class='col2da' style="width:15%;">
            {{ select("fuerza2[0]", datosFuerza, "value" : listafuerza2[0], "class" : "form-control") }}
          </div>
        </div>
        <div class='fila col3e'>
          <div class='col2da' style="width:35%;">EXTENSORES</div>
          <div class='col2da' style="width:15%;">
            {{ select("fuerza1[1]", datosFuerza, "value" : listafuerza1[1], "class" : "form-control") }}
          </div>
          <div class='col2da' style="width:35%;">EXTENSORES</div>
          <div class='col2da' style="width:15%;">
            {{ select("fuerza2[1]", datosFuerza, "value" : listafuerza2[1], "class" : "form-control") }}
          </div>
        </div>
        <div class='fila col3e'>
          <div class='col2da' style="width:35%;">ABDUCTORES</div>
          <div class='col2da' style="width:15%;">
            {{ select("fuerza1[2]", datosFuerza, "value" : listafuerza1[2], "class" : "form-control") }}
          </div>
          <div class='col2da' style="width:35%;">ABDUCTORES</div>
          <div class='col2da' style="width:15%;">
            {{ select("fuerza2[2]", datosFuerza, "value" : listafuerza2[2], "class" : "form-control") }}
          </div>
        </div>
        <div class='fila col3e'>
          <div class='col2da' style="width:35%;">ADUCTORES</div>
          <div class='col2da' style="width:15%;">
            {{ select("fuerza1[3]", datosFuerza, "value" : listafuerza1[3], "class" : "form-control") }}
          </div>
          <div class='col2da' style="width:35%;">ADUCTORES</div>
          <div class='col2da' style="width:15%;">
            {{ select("fuerza2[3]", datosFuerza, "value" : listafuerza2[3], "class" : "form-control") }}
          </div>
        </div>
        <div class='fila col3e'>
          <div class='col2da' style="width:35%;">ROTADOR INTERNO</div>
          <div class='col2da' style="width:15%;">
            {{ select("fuerza1[4]", datosFuerza, "value" : listafuerza1[4], "class" : "form-control") }}
          </div>
          <div class='col2da' style="width:35%;">ROTADOR INTERNO</div>
          <div class='col2da' style="width:15%;">
            {{ select("fuerza2[4]", datosFuerza, "value" : listafuerza2[4], "class" : "form-control") }}
          </div>
        </div>
        <div class='fila col3e'>
          <div class='col2da' style="width:35%;">ROTADOR EXTERNO</div>
          <div class='col2da' style="width:15%;">
            {{ select("fuerza1[5]", datosFuerza, "value" : listafuerza1[5], "class" : "form-control") }}
          </div>
          <div class='col2da' style="width:35%;">ROTADOR EXTERNO</div>
          <div class='col2da' style="width:15%;">
            {{ select("fuerza2[5]", datosFuerza, "value" : listafuerza2[5], "class" : "form-control") }}
          </div>
        </div>
        ...
        <div class='fila col3e'>
          ...
          <div class='col2da' style="width:40%;">
            {{ text_field("cualayuda", "type" : "text", "class" : "form-control fecha") }}
          </div>
        </div>
        <div class='fila col3e'>
          <div class='col2da' style="width:25%;">EQUILIBRIO ESTATICO</div>
          <div class='col2da' style="width:25%;">
            {{ text_field("equilibrioestatico", "type" : "text", "class" : "form-control fecha") }}
          </div>
          <div class='col2da' style="width:25%;">EQUILIBRIO DINAMICO</div>
          <div class='col2da' style="width:25%;">
            {{ text_field("equilibriodinamico", "type" : "text", "class" : "form-control fecha") }}
          </div>
        </div>
