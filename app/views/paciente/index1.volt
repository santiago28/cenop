<div class="row">
  <nav>
    <ul class="pager">
      <li class="previous">{{ link_to("paciente/index", "Go Back") }}</li>
      <li class="next">{{ link_to("paciente/new", "Create ") }}</li>
    </ul>
  </nav>
</div>
...
<div class="row">
  ...
  <div class="col-sm-11">
    <nav>
      <ul class="pagination">
        <li>{{ link_to("paciente/search", "First") }}</li>
        <li>{{ link_to("paciente/search?page="~page.before, "Previous") }}</li>
        <li>{{ link_to("paciente/search?page="~page.next, "Next") }}</li>
        <li>{{ link_to("paciente/search?page="~page.last, "Last") }}</li>
      </ul>
    </nav>
  </div>
</div>
