  ...
  <div>
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div style="list-style:none; width:100%" class="col-md-12">
          {{ form("ordenproduccion/save", "method":"post", "autocomplete" : "off", "class" : "form-horizontal", "name": "formOrden") }}
          <br />
          {{ hidden_field("idPaciente") }}
          {{ hidden_field("idOrden") }}
          {{ hidden_field("tipoTecnico") }}
          {{ hidden_field("idEmpresa") }}
          <div id="clock">OP: &nbsp;{{op}}</div>
          <div id="imprimir">
            <div class='seccion encabezado'>
              <div class="fila col3">
                <div style="width:10%;">
                  {{ image("img/logo.jpg", "alt": "", "style":"width:100%;") }}
                </div>
              ...
              <div class='fila col3'>
                ...
                <div style='width:45%;'>{{ text_field("doctorRemite", "type" : "text", "class" : "form-control tipotecnico") }}</div>
                <div style='width:20%;'>Código o licencia: </div>
                <div style='width:20%;'>{{ text_field("codigoLicencia", "type" : "text", "class" : "form-control tipotecnico") }}</div>
              </div>
              <div class="clear"></div>
            </div>
            <div class="seccion">
              ...
              <div class='fila col2'>
                <div>
                  <div class="checkbox">
                    <label>
                      ...
                      {{ check_field('autorizacionServicio', 'value':'1', "class":"check") }}
                ...
                <div>
                  <div class="checkbox">
                    <label>
                      FORMULA
                      {{ check_field('formula', 'value':'1', "class": "check") }}
                      <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                    </label>
                  </div>
                </div>
              ...
              <div class='fila col2'>
                <div>
                  <div class="checkbox">
                    <label>
                      HISTORIA CL
                      {{ check_field('historiaClinica', 'value':'1', "class": "check") }}
                      <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                    </label>
                  </div>
                </div>
                <div>
                  <div class="checkbox">
                    <label>
                      CÉDULA
                      {{ check_field('cedula', 'value':'1', "class": "check") }}
                      <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                    </label>
                  </div>
                </div>
              ...
              <div class='fila col2'>
                <div>
                  <div class="checkbox">
                    <label>
                      ACTA DE ENTREGA
                      {{ check_field('actaEntrega', 'value':'1', "class": "check") }}
                      <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                    </label>
                  </div>
                </div>
                <div>
                  <div class="checkbox">
                    <label>
                      CÉDULA ACUDIENTE
                      {{ check_field('cedulaAcudiente', 'value':'1', "class": "check") }}
                      <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                    </label>
                  </div>
                </div>
              ...
              <div class='fila col2'>
                <div>
                  <div class="checkbox">
                    <label>
                      COPA
                      {{ check_field('copa', 'value':'1', "class": "check") }}
                      <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                    </label>
                  </div>
                </div>
                <div>
                  <div class="checkbox" style="margin-left: 17px; width:280px;">
                    {{ text_field("fechaAutorizacion", "type" : "text", "class" : "form-control tipotecnico calendario", "placeholder" : "FECHA AUTORIZACIÓN") }}
                  </div>
                </div>
              </div>
              <div class='fila col2'>
                <div>
                  <div class="checkbox" style="margin-left: 17px; width:280px;">
                    {{ text_field("vencimientoAutorizacion", "type" : "text", "class" : "form-control tipotecnico calendario", "placeholder" : "VENCIMIENTO AUTORIZACIÓN") }}
                  </div>
                </div>
                <div>
                  <div class="checkbox" style="margin-left: 17px; width:280px;">
                    {{ text_field("nroFactura", "type" : "text", "class" : "form-control tipotecnico", "placeholder" : "FACTURA No") }}
                  </div>
                </div>
              </div>
              <div class="clear"></div>
            ...
            <div class="seccion">
              ...
              <div class='fila center'>
                <div style='margin: 0 auto;'>
                  {{ select("tipoOrtesis", tiposOrtesis,  "class" : "form-control tipotecnico estadoPaciente") }}
                  <br/><br/>
                  {# {{ image("img/ProtesisMiembroInferiorTransfemoral.png") }} #}
                  <img src="" id="imagenprotesis">
                </div>
              </div>
              <div id="medidas">
                {% for medidas in querymedida %}
            ...
            <div class="seccion">
              ...
              <div class='fila center'>
                {{ text_area('observaciones', "class" : "form-control tipotecnico", "rows": "10", "style": "margin-top:20px; margin-left:20px; width:97%; margin-bottom:20px;") }}
              </div>
              <div class="clear"></div>
            </div>
            <div class="seccion">
              <div class='fila col3e'>
                <div class='col2da'><span>Elaboró</span>{{ text_field("elaboro", "type" : "text", "class" : "form-control tipotecnico") }}</div>
                <div class='col2da'><span>Responsable de aprobación</span>{{ text_field("responsableAprobacion", "type" : "text", "class" : "form-control tipotecnico") }}</div>
                <div class='col2da'><span>Recibe</span>{{ text_field("recibe", "type" : "text", "class" : "form-control tipotecnico") }}<span style='font-weight: normal;'></span></div>
              </div>
              <div class='fila col3e'>
                <div class='col2da'><span style='font-weight: normal;'></span></div>
                <div class='col2da'><span style='font-weight: normal;'></span></div>
                <div class='col2da'>Fecha{{ text_field("fechaRecibido", "type" : "text", "class" : "form-control tipotecnico calendario", "id" : "fieldFecharecibido", "placeholder": "Fecha Recibido") }}<span style='font-weight: normal;'></span></div>
              </div>
              <div class="clear"></div>
            </div>
            <div class="seccion">
              ...
              <div id="materiaprima">
                ...
                <div class="fila col3e">
                  ...
                  {# <div class="col2da"><input type="text" name="responsable[]" class="form-control tipotecnico" value="{{materia.responsable}}"><span style="font-weight: normal;"></span></div> #}
                  <div class="col2da">{{ select("responsable[]", listatecnicos, "value" : materia.responsable, "class" : "form-control cambiarCliente") }}</div>
                  ...
                  <div class="col2da" style="width:11%;"><a href="#eliminar_elemento" rel="tooltip" title="Eliminar" class="material-icons eliminar_fila" style="color:#757575; text-decoration: none;" data-toggle = "modal" id="{{ url("ordenproduccion/deletemateria/"~materia.idMateria) }}">&#xE872;</a></div>
                </div>
                {% endfor %}
              </div>
              <div class="quitar-vista" style="justify-content: center; align-content: center;">
            ...
            <div class="seccion">
              ...
              {% for entrenamiento in queryentrenamiento %}
              <div class='fila col3e'>
            ...
            <div class="seccion">
              ...
              <div class="fila center">
                {{ text_area('historiaClinicaTexto', "class" : "form-control", "rows": "10", "style": "margin-top:20px; margin-left:20px; width:97%; margin-bottom:20px;") }}
              ...
              <div class="fila col2">
                ...
                <div>
                  ...
                  {% else %}
                  {{ image("files/"~fotoFirma, "class":"img-responsive") }}
                  {% endif %}
                  {% else %}
                  {{ image("files/"~fotoFirma, "class":"img-responsive") }}
                  {% endif %}
...
<div id="ModalCitasEntrenamiento" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      {{ form("Ordenproduccion/createAgendaEntrenamiento", "method":"post", "autocomplete" : "off") }}
...
<div id="ModalArchivos" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      {{ form("Ordenproduccion/SubirArchivo", "method":"post", "autocomplete" : "off", "enctype" : "multipart/form-data") }}
      {{ hidden_field("idOrden") }}
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div id="ModalFirma" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      {{ form("Ordenproduccion/SubirFirma", "method":"post", "autocomplete" : "off", "enctype" : "multipart/form-data") }}
      {{ hidden_field("idOrden") }}
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
...
$.get("<?php echo $this->url->get('Ordenproduccion/BuscarDatosOrden'); ?>/", { "idOrden": idOrden}, function(data){
  ...
  {#$('input[name="responsableSeguimiento[]"]').each(function(i,v) {
    $(this).val(responsable[i]);
  });#}

  {#$('input[name="fechaProceso[]"]').each(function(i,v) {
    $(this).val(fechaProceso[i]);
  });#}
  ...
  {#for (var i = 0; i < calificacion.length; i++) {
    var checkedString = $('input[name="calificacion['+ i + ']"').map(function() { return this }).get();
    for (var j = 0; j < checkedString.length; j++) {
      if ($(checkedString[j]).val() == calificacion[i]) {
        $(checkedString[j]).prop('checked', true);
      }
