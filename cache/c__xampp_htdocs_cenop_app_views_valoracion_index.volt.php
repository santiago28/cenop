      ...
      <div class="panel-body">
        ...
        <div class="table-responsive col-md-10" style="border-radius: 5px;width: 100%;margin: 0px auto; float: none;">
          <table class="table table-bordered" id="mytable">
            ...
            <tbody>
              <?php if (isset($listavaloracion)) { ?>
              <?php foreach ($listavaloracion as $valoracion) { ?>
              <tr>
                ...
                <td><?= $this->tag->linkTo(['valoracion/edit/' . $valoracion->idValoracion, '&#xE8B6;', 'class' => 'material-icons', 'style' => 'color:#757575; text-decoration: none;']) ?></td>
              </tr>
              <?php } ?>
              <?php } ?>
            </tbody>
