<div class="container col-xs-12" style="margin-top:40px;">
  <div>
    <?= $this->tag->form(['ortopedista/save', 'method' => 'post', 'autocomplete' => 'off', 'class' => 'form-horizontal']) ?>
    <?= $this->tag->hiddenField(['idOrtopedista']) ?>
...
<div style="list-style:none; width:100%" class="col-md-12">
  ...
  <div class="col-md-6">
    <div class="form-group col-md-12">
      ...
      <div>
        <?= $this->tag->select(['estado', $listaestado, 'class' => 'form-control']) ?>
      </div>
    </div>
  </div>
</div>
<div style="list-style:none; width:100%" class="col-md-12">
  <div class="col-md-6">
    <div class="form-group col-md-12">
      ...
      <div>
        <?= $this->tag->passwordField(['contrasena', 'size' => 30, 'class' => 'form-control', 'id' => 'fieldContrasena']) ?>
      </div>
    </div>
  </div>
</div>
