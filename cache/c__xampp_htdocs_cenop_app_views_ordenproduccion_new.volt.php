    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div style="list-style:none; width:100%" class="col-md-12">
          <?= $this->tag->form(['ordenproduccion/create', 'method' => 'post', 'autocomplete' => 'off', 'class' => 'form-horizontal']) ?>
          <br />
          ...
          <div id="imprimir">
              ...
              <div class='fila col2'>
                <div>
                  <div class="checkbox">
                    <label>
                      ...
                      <?= $this->tag->checkField(['autorizacionServicio', 'value' => '1']) ?>
                ...
                <div>
                  <div class="checkbox">
                    <label>
                      FORMULA
                      <?= $this->tag->checkField(['formula', 'value' => '1']) ?>
                      <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                    </label>
                  </div>
                </div>
              ...
              <div class='fila col2'>
                <div>
                  <div class="checkbox">
                    <label>
                      HISTORIA CL
                      <?= $this->tag->checkField(['historiaClinica', 'value' => '1']) ?>
                      <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                    </label>
                  </div>
                </div>
                <div>
                  <div class="checkbox">
                    <label>
                      CÉDULA
                      <?= $this->tag->checkField(['cedula', 'value' => '1']) ?>
                      <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                    </label>
                  </div>
                </div>
              ...
              <div class='fila col2'>
                <div>
                  <div class="checkbox">
                    <label>
                      ACTA DE ENTREGA
                      <?= $this->tag->checkField(['actaEntrega', 'value' => '1']) ?>
                      <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                    </label>
                  </div>
                </div>
                <div>
                  <div class="checkbox">
                    <label>
                      CÉDULA ACUDIENTE
                      <?= $this->tag->checkField(['cedulaAcudiente', 'value' => '1']) ?>
                      <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                    </label>
                  </div>
                </div>
              ...
              <div class='fila col2'>
                <div>
                  <div class="checkbox">
                    <label>
                      COPA
                      <?= $this->tag->checkField(['copa', 'value' => '1']) ?>
                      <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
                    </label>
                  </div>
                </div>
                <div>
                  <div class="checkbox" style="margin-left: 17px; width:280px;">
                    <?= $this->tag->textField(['fechaAutorizacion', 'type' => 'text', 'class' => 'form-control calendario', 'placeholder' => 'FECHA AUTORIZACIÓN']) ?>
                  </div>
                </div>
              </div>
              <div class='fila col2'>
                <div>
                  <div class="checkbox" style="margin-left: 17px; width:280px;">
                    <?= $this->tag->textField(['vencimientoAutorizacion', 'type' => 'text', 'class' => 'form-control calendario', 'placeholder' => 'VENCIMIENTO AUTORIZACIÓN']) ?>
                  </div>
                </div>
                <div>
                  <div class="checkbox" style="margin-left: 17px; width:280px;">
                    <?= $this->tag->textField(['nroFactura', 'type' => 'text', 'class' => 'form-control', 'placeholder' => 'FACTURA No']) ?>
                  </div>
                </div>
              </div>
              <div class="clear"></div>
            ...
            <div class="seccion">
              ...
              <?= $this->tag->textArea(['observaciones', 'class' => 'form-control', 'rows' => '10', 'style' => 'margin-top:50px; margin-left:20px; width:97%; margin-bottom:20px;']) ?>
            </div>
            <div class="seccion">
              ...
              <div class='fila col3e'>
                ...
                <div class='col2da'><span style='font-weight: normal;'></span></div>
                <div class='col2da'><?= $this->tag->textField(['fechaRecibido', 'type' => 'date', 'class' => 'form-control', 'id' => 'fieldFecharecibido', 'placeholder' => 'Fecha Recibido']) ?><span style='font-weight: normal;'></span></div>
              </div>
              <div class="clear"></div>
            </div>
            <div class="seccion">
