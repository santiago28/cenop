<div class="container col-xs-12" style="margin-top:40px;">
  ...
  <div style="list-style:none; width:100%" class="col-md-12">
    <?= $this->tag->form(['detalleactividad/save', 'method' => 'post', 'autocomplete' => 'off', 'class' => 'form-horizontal']) ?>
    <br>
    <?= $this->tag->hiddenField(['idActividad']) ?>
    ...
    <div id="imprimir">
      ...
      <div class="seccion">
        ...
        <div class='fila col3e' id="montaje">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[0]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3e' id="verificacion">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[1]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3'>
          <div>FECHA</div>
        ...
        <div class='fila col3e' id="alineacionestatica">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[2]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3e' id="alineaciondinamica">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[3]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3e' id="puntosapoyo">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[4]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3e' id="zona">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[5]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3e' id="marcha">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[6]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3e' id="comodidad">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[7]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3'>
          <div>FECHA</div>
        ...
        <div class='fila col3e' id="altura">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[8]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3e' id="condicion">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[9]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3e' id="apariencia">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[10]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3e' id="adaptacion">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[11]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3'>
          <div>FECHA</div>
        ...
        <div class='fila col3e' id="tiempoentrenamiento">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[12]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3e' id="instruccionesfunc">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[13]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3e' id="instruccionesuso">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[14]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3e' id="infomantenimiento">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[15]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3'>
          <div>FECHA</div>
        ...
        <div class='fila col3e' id="actaentrega">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[16]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3e' id="producto">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[17]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3e' id="manual">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[18]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3'>
          <div>FECHA</div>
        ...
        <div class='fila col3e' id="apliacacion">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[19]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3e' id="programacion">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[20]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3e' id="solicitudgarantia">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[21]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3e' id="solicituddevolucion">
          ...
          <div class="col2da">
            <?= $this->tag->textArea(['observacion[22]', 'class' => 'form-control']) ?>
          </div>
        </div>
        <div class='fila col3'>
          <div>FECHA</div>
